...
export type ResourceType = 'prompt' | 'skill' | 'component' | 'mcp' | 'protocol' | 'workflow' | 'template' | 'snippet';
...
export type WorkflowNodeTypes = 'start' | 'end' | 'task' | 'condition' | 'parallel' | 'loop' | 'subprocess';
